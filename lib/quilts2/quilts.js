(function() {
	...
	const inputVue = new Vue({
		el: '#input',
		data: {
			// TODO need more metadata about each cell
			// triangle 1 and 2, orientation info
			matrix: [
				[4, 4, 1, 1],
				[4, 3, 1, 1],
				[2, 3, 3, 4],
			...
			// TODO rotation: squares or diamonds; changes the overall snap-to sizes, but that's about it
			matrixSize: 4,

			squareSize: 1.5, // how big is the smallest square
			// TODO change to final width, not rows/cols
		...
		computed: {
			matrixWidth: function() { return this.matrixSize; }, // TODO whoops, copied the wrong one? change to size
			matrixHeight: function() { return this.matrixSize; }, // don't use width and height, just keep the pattern as squares
		},
		methods: {
			...
			// TODO change input to a painter
			//  - have a color pallet
			//  - pick a color and then start placing it on the matrix
