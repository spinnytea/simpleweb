(function() {
	...
	function share() {
		console.log(decodeInputVue(encodeInputVue(inputVue._data)));
	}
	function load(data) {
		// squareSize, quiltWidth, quiltHeight, globalOffsetX, globalOffsetY, globalOffsetR, palette, selectedColor, tCols, tRows, texture
	}
