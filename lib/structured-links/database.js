window['structured-links-database'] = {
	registry: [
		...
		{ id: 'stack-lang',   display: 'Language',     type: 'stack-level', description: 'What "programming language" are using?\nAt the end of the day, it\'s all javascript,\nbut there are various dialects.' },
		{ id: 'stack-import', display: 'Import',       type: 'stack-level', description: 'Ways of describing how to import various\njavascript files into one larger file.' },
		{ id: 'stack-fw',     display: 'Framework',    type: 'stack-level', description: 'UI Framework. Tools, features, patterns for\ncohesive development.' },
		{ id: 'stack-markup', display: 'Markup',       type: 'stack-level', description: 'Static markup for the laying out the page.\nAll of these are XML based.' },
		{ id: 'stack-comp',   display: 'Compilation',  type: 'stack-level', description: 'How do we compile our code?\nJavascript is a scripting language.\nBut we can still have post-processors to\ncheck and and clean things up.' },
		{ id: 'stack-build',  display: 'Build',        type: 'stack-level', description: 'The build pipeline for packaging everything\ntogether. While compilation focuses on\nprocessing javascript, this is more about\npackaging the whole project together for release.' },
		{ id: 'stack-dist',   display: 'Distribution', type: 'stack-level', description: 'How do we share our code?\nWhere do we get libraries from the community.' },

		// Data: REST, HTTP, HTTP/2, AJAX, Fetch, Request, Axios
		{ id: 'data-rest',    display: 'REST',    type: 'spec',     link: 'https://www.w3.org/2001/sw/wiki/REST' },
		{ id: 'data-http',    display: 'HTTP',    type: 'spec',     link: 'https://www.w3schools.com/whatis/whatis_http.asp' },
		{ id: 'data-http2',   display: 'HTTP/2',  type: 'spec',     link: 'https://developers.google.com/web/fundamentals/performance/http2' },
		{ id: 'data-ajax',    display: 'AJAX',    type: 'standard', link: 'https://www.w3schools.com/xml/ajax_intro.asp' },
		{ id: 'data-fetch',   display: 'Fetch',   type: 'spec',     link: 'https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API' },
		{ id: 'data-request', display: 'Request', type: 'library',  link: 'https://developer.mozilla.org/en-US/docs/Web/API/Request' },
		...
		{ id: 'javascript', display: 'JavaScript',   type: 'standard', link: 'https://www.w3schools.com/js/DEFAULT.asp' },
		{ id: 'es5',        display: 'ES5',          type: 'spec',     link: 'https://www.w3schools.com/js/js_es5.asp' },
		{ id: 'es7',        display: 'ES2016',       type: 'spec',     link: 'https://en.wikipedia.org/wiki/ECMAScript#7th_Edition_%E2%80%93_ECMAScript_2016' },
		...
		{ id: 'webasm',     display: 'WebAssembly',  type: 'standard', link: 'https://developer.mozilla.org/en-US/docs/WebAssembly' },
		...
		{ id: 'xml',  display: 'XML',  type: 'standard', link: 'https://www.w3schools.com/xml/xml_whatis.asp' },
		{ id: 'dom',  display: 'DOM',  type: 'standard', link: 'https://www.w3schools.com/js/js_htmldom.asp' },
		{ id: 'html', display: 'HTML', type: 'standard', link: 'https://www.w3schools.com/html/html_intro.asp' },
		...
		{ id: 'cdn',   display: 'CDN',   type: 'spec',    link: 'https://en.wikipedia.org/wiki/Content_delivery_network' },
		...
		{ id: 'makefile', display: 'Makefile', type: 'standard', link: '' },
		{ id: 'webpack',  display: 'Webpack',  type: 'library',  link: 'https://webpack.js.org/' },

		// Import: AMD, CommonJS, SystemJS
		{ id: 'amd',      display: 'AMD',      type: 'spec', link: 'https://requirejs.org/docs/whyamd.html' },
		{ id: 'commonjs', display: 'CommonJS', type: 'spec', link: 'https://requirejs.org/docs/commonjs.html' },
		{ id: 'systemjs', display: 'SystemJS', type: 'spec', link: 'https://github.com/systemjs/systemjs' },
	],
	stack: {
		'stack-data': ['data-rest', 'data-http', 'data-http2', 'data-ajax', 'data-fetch', 'data-request', 'data-axios'],
