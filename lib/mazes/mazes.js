(function() {
	...
	const maze = new Vue({
		...
		computed: {
			...
			board_height: function() { return this.board.length; },
			board_width: function() { return this.board[0].length; },
		},
		methods: {
			...
			// REVIEW the api for goto is kind of awful
			goto: function(r, c) {
				const cell = this.board[r*(this.board_height-1)][c*(this.board_width-1)];
				this.clickToMove(cell); // REVIEW it feels weird that we are calling 'click to move' (moveDir / moveCell ?)
			},
			...
			wander: function() {
				...
				if(path) {
					...
					// TODO wander/generation loop needs a conditional flag
					// single timeout so we can let the last room render has having been visited
		...
		mounted: function() {
			window.addEventListener('keydown', (e) => {
				...
				switch(e.keyCode) {
					...
					// goals
					case 82: /* r */ case 49: /* 1 */ this.goto(0, 0); break;
					case 89: /* y */ case 50: /* 2 */ this.goto(0, 1); break;
					case 71: /* g */ case 51: /* 3 */ this.goto(1, 0); break;
					case 66: /* b */ case 52: /* 4 */ this.goto(1, 1); break;
					// wander
