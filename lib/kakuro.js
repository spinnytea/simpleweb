(function() {
	...
	// TODO alternate inputs
	//  - for dev/testing, all entry has been done with the keyboard, so that's pretty robust
	//  - test using only the mouse
	//  - test using mobile/touch
	...
	function makeCell() {
		return {
			...
			possibleUser: new Set(ONE_THROUGH_NINE), // IDEA do we need a 'match to current possible' button?
			$rightHead: null,
			$downHead: null,
